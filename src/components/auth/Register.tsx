...
const userFormSchema = z.object({
  ...
  email: z.string().trim().min(1, { message: 'Endereço de email é obrigatório' }).email({ message: 'Email inválido' }),
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  {...register('password')}
                  disabled={isLoading}
                  className="w-full rounded-md border-0 p-1.5 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  type="button"
